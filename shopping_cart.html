...
<html lang="en">
      ...
      <section id="mainHeaderShop" class="d-none d-md-block">
        <div class="container">
          <div class="row">
            ...
            <div
              class="col-lg-5 links d-flex justify-content-center align-items-center"
            >
              <form action="">
  ...
  <div class="mobile-top-bar">
    ...
    <a href="./index.html" class="logo">
      <img src="./images/logo.png" alt="Ecobazar Logo" />
    </a>
      ...
      <section id="ShoppingCart">
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-8 col-6">
              <table class="table1">
                ...
                <tr>
                  <td>
                    <div class="row">
                        <div class="col-md-4"> <img src="./images/shoppingcartSmallgreenCapsicum.png" class="img-fluid" alt="" /></div>
                        <div class="col-md-8"><h3>Green Capsicum</h3></div>
                    </div>
                  </td>
                  <td><h6 class="price">$14.00</h6></td>
                  <td>
                    <div class="counter">
                  ...
                  <td>
                    <div class="row d-flex">
                        <div class="col-md-6"><h4 class="subtotal">$70.00</h4></div>
                        <div class="col-md-6"><button class="closeBtn d-none d-md-block"><i class="fa-solid fa-xmark"></i></button></div>
                    </div>
                  </td>
                </tr>
                <tr>
                  <td>
                    <div class="row">
                        <div class="col-md-4"> <img src="./images/shoppingcartSmallredCapsicum.png" class="img-fluid" alt="" /></div>
                        <div class="col-md-8"><h3>Red Capsicum</h3></div>
                    </div>
                  </td>
                  <td><h6 class="price">$14.00</h6></td>
                  <td>
                ...
                <tr>
                    <td colspan="2"><a href="./shop.html">Return to shop</a></td>
                    <td colspan="2"><a href="#">Update Cart</a></td>
                </tr>
              </table>
              <div class="coupon col-5">
                <div class="row">
                    <div class="col-5">
                        <h6>Coupon Code</h6>
                    </div>
            ...
            <div class="col-md-4 cartTable">
                <h4>Cart Total</h4>
                <p>Subtotal:<span class="subtotal1">$84.00</span></p>
                <p>Shipping:<span class="subtotal2">Free</span></p>
                <p>Total:<span class="subtotal3">$84.00</span></p>
                <a href="./billing Information.html">Proceed to checkout</a>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-3 logo">
              ...
              <div class="row">
                <a href="tel:2195550114"
                  >(219) 555-0114 <span>or</span> Proxy@gmail.com</a
                >
              </div>
            </div>
          ...
          <div class="row EndFooter">
            <div class="col-lg-6">
              <a href="#"
                ><h2>Ecobazar eCommerce © 2021. All Rights Reserved</h2></a
              >
            </div>
            <div class="col-lg-6">
              <div class="row">
                <div class="col-2 me-2">
                  <a href="#"
                    ><img src="./images/Method=ApplePay.png" alt=""
                  /></a>
                </div>
                <div class="col-2 me-2">
                  <a href="#"><img src="./images/Method=Visa.png" alt="" /></a>
                </div>
                <div class="col-2 me-2">
                  <a href="#"
                    ><img src="./images/Method=Discover.png" alt=""
                  /></a>
                </div>
                <div class="col-2 me-2">
                  <a href="#"
                    ><img src="./images/Method=Mastercard.png" alt=""
                  /></a>
                </div>
                <div class="col-2">
